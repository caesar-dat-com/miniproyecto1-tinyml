...
|---|---|---|---|
| 1 | Dataset **propio** con sensor inercial | Captura con el LSM9DS1 del Nano 33, 3 integrantes | ☐ |
| 2 | **5 clases de movimiento + reposo** (reposo no cuenta) | flexion, extension, pronacion, supinacion, puno + reposo | ☐ |
| 3 | **Un actuador distinto por clase**; **los LEDs NO valen** | Servo, motor DC, buzzer ×2 patrones, OLED (plan B: relé) | ☐ |
| 4 | Entrenamiento en **Edge Impulse**, proyecto **público** | Enlace en `edge-impulse/README.md` y en el paper | ☐ |
