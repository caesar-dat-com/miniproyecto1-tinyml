...
| 3 | **Una acción observable por clase**; videojuegos pueden usar acciones digitales distintas; **LEDs solos NO valen** | La guía 3.2 admite acciones en el juego; falta demostrar las cinco clases | ◑ |
...
Revisión actualizada y evidencia por requisito: [auditoria-clase.md](auditoria-clase.md).
